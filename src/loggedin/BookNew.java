 ...
 * @author Ivan Adcan
 */
public class BookNew extends javax.swing.JFrame {
    ...
    public void loadRoomDetails() {
        ...
        try (Connection con = DriverManager.getConnection(SUrl, SUser, SPass)) {
            ...
            while (rs.next()) {
                ...
                price1.setText("P " + discountPrice1);
                price2.setText("P " + discountPrice2);
                getPrice1 = Double.toString(discountPrice1);
                getPrice2 = Double.toString(discountPrice2);
            }
        } catch (Exception e) {
